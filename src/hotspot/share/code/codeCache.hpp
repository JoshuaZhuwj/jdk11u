...
class CodeCache : AllStatic {
 ...
 public:
  ...
  static void trace_non_profiled_hot_code_heap_activities(outputStream* st, const char* event, nmethod* nm, bool detailed=true);
  ...
  // Filter methods: is obsolete because of DirectivesStack_lock.
//  static bool is_hot_non_profiled_method(AbstractCompiler *compiler, const methodHandle& method, int comp_level) {
//    if (!is_c2_compile(comp_level)) {
//      return false;
//    }
//
//    // TODO: try to test with this judgement turned off
//    if (method->is_native()) {
//      return false;
//    }
//
//    DirectiveSet* directive = DirectivesStack::getMatchingDirective(method, compiler);
//    bool alloc_in_hot_non_profiled_cache = directive->AllocInNonProfiledHotCodeHeapOption;
//    DirectivesStack::release(directive);
//
//    return alloc_in_hot_non_profiled_cache;
//  }
